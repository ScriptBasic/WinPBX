...
OPERATOR + (BYREF int96 AS CInt96, BYVAL nValue AS LONG) AS CInt96
OPERATOR + (BYVAL nValue AS LONG, BYREF int96 AS CInt96) AS CInt96
OPERATOR + (BYREF int96 AS CInt96, BYVAL nValue AS DOUBLE) AS CInt96
OPERATOR + (BYVAL nValue AS DOUBLE, BYREF int96 AS CInt96) AS CInt96
